        ...
        <div class="experience-info-block__experience-list-block">
            <div class="experience-info-block__experience-info">
                <div class="experience-info-block__experience-summary">
                    <div class="experience-info-block__experience-counter">
                        01
                    </div>
                    <div class="experience-info-block__experience-name-block">
                        <h1 class="experience-info-block__experience-name">
                            uCoz
                        </h1>
                        <h3 class="experience-info-block__experience-degree">
                            {{ $t('message.frontEndDev') }}
                        </h3>
                        <h3 class="experience-info-block__experience-period">
                            {{
